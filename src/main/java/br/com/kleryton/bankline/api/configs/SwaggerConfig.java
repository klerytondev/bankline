package br.com.kleryton.bankline.api.configs;
	  ...
	  @Bean
	    public Docket api() {
	        return new Docket(DocumentationType.SWAGGER_2)
	                .select()
	                .apis(RequestHandlerSelectors.basePackage("br.com.kleryton.bankline.api"))
	    ...
	    private ApiInfo showMetadata() {
	        return new ApiInfoBuilder()
	                .title("BankLine - API Restfull")
	                .description("BankLine")
	                .version("1.0")
